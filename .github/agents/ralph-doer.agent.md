...
hooks:
  PreToolUse:
    - type: command
      command: 'pwsh -NoProfile -File ./.github/hooks/ralph-doer-terminal-policy.ps1'
      windows: 'powershell -NoProfile -ExecutionPolicy Bypass -File ".github\hooks\ralph-doer-terminal-policy.ps1"'

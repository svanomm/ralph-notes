...
5. After creating files, agents MUST register them by running: `uv run scripts/update_index.py` — the script scans for all unregistered notes and renames them to `{ID}.md`
